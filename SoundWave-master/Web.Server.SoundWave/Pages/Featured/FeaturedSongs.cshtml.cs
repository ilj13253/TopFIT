...
using Web.Server.SoundWave.Pages.Songs;

namespace Web.Server.SoundWave.Pages.Featured
{
    public class FeaturedSongsModel(SoundWaveDBContext soundWaveDBContext) : PageModel
    {
